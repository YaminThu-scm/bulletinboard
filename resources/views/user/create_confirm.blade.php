            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center mb-4">
                        <h5 class="">Create User Confirmation</h5>
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" id="">
                            ...
                            <div class="form-group row mb-3 mb-md-4">
                                ...
                                <div class="col-sm-8 show-password">
                                    <input type="password" name="password" value="{{ old('password') }}"
                                        class="form-control" id="myInput" autocomplete="current-password" required
                            ...
                            <div class="form-group row mb-3 mb-md-4">
                                ...
                                <div class="col-sm-8">
                                    <input type="hidden" name="phno" value="{{ old('phno') }}" class="form-control"
