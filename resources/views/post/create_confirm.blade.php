                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('post.create.confirm') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-3 mb-md-4">
                            ...
                            <div class="col-sm-8">
                                <input type="hidden" class="form-control" id="inputTitle" name="title" placeholder="Title" value="{{old('title')}}">
                                <span>{{old('title')}}</span>
                            </div>
                        </div>
                        <div class="form-group row mb-5">
                            ...
                            <div class="col-sm-8">
                                <textarea hidden class="form-control" id="inputDesc" rows="3" name="description" required autocomplete autofocus readonly="readonly">{{old('description')}}</textarea>
